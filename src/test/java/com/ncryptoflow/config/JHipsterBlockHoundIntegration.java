package com.ncryptoflow.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.ncryptoflow.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.ncryptoflow.security.DomainUserDetailsService", "createSpringSecurityUser");
